...
public class SubAccountListScreen extends AbstractSimiContainerScreen<SubAccountListMenu> {
    ...
    protected void startPopup() {
        ...
        int x = leftPos - 12;
        int y = topPos - 5;
        Label authorizationTypeLabel = new ScrollingLabel(x + 67 + 3, y + 89 + 5, Component.empty(), 108 - 6).withShadow();
...
//        partialTicks = minecraft.getFrameTime();
    ...
    protected int renderSubAccount(GuiGraphics graphics, SubAccount subAccount, int yOffset, int mouseX, int mouseY,
        ...
        widget.doRender(graphics, mouseX - leftPos - 3 - 6, mouseY - topPos - 16 - 9, partialTicks);
    ...
    public boolean action(@Nullable GuiGraphics graphics, double mouseX, double mouseY, int click) {
        ...
        //renderActionTooltip(graphics, ImmutableList.of(Component.literal("x: "+x), Component.literal("y: "+y)), mx, my);
        ...
        for (SubAccount subAccount : menu.contentHolder.getAlphabetizedSubAccounts()) {
            ...
            //renderActionTooltip(graphics, ImmutableList.of(Component.literal("cx: "+cx), Component.literal("cy: "+cy)), mx, my + 30);

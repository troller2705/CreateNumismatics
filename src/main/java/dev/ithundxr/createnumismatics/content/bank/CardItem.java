...
public class CardItem extends Item {
    ...
    public static ItemStack clear(ItemStack itemStack) {
        itemStack.remove(AllDataComponents.ACCOUNT_ID);

        return itemStack;
    }

    public static ItemStack set(ItemStack itemStack, UUID id) {
        itemStack.set(AllDataComponents.ACCOUNT_ID, id);
    ...
    public static UUID get(ItemStack itemStack) {
        ...
        return itemStack.get(AllDataComponents.ACCOUNT_ID);
    }

    public static boolean isBound(ItemStack itemStack) {
        return itemStack.has(AllDataComponents.ACCOUNT_ID);
    }

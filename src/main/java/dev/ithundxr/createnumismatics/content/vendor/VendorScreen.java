...
public class VendorScreen extends AbstractSimiContainerScreen<VendorMenu> {
    ...
    protected void init() {
        ...
        extractionIndicator = new Indicator(x + 29, y + background.height - 30, Component.empty());
        ...
        for (Coin coin : Coin.values()) {
            ...
            coinLabels[i] = new Label(baseX + 18, baseY + 5, Component.empty()).withShadow();
        ...
        modeLabel = new Label(x + 90 + 3 + 9, y + 40 + 5, Component.empty()).withShadow();
    ...
    public boolean mouseScrolled(double mouseX, double mouseY, double scrollX, double scrollY) {
        if (this.hoveredSlot != null && this.hoveredSlot.hasItem() && this.hoveredSlot.index == VendorMenu.FILTER_SLOT_INDEX) {
            NumismaticsPackets.PACKETS.send(new ScrollSlotPacket(this.hoveredSlot.index, scrollY, AllKeys.shiftDown()));
            return true;
        }

...
public abstract class NumismaticsRecipeProvider extends RecipeProvider {
  ...
  public NumismaticsRecipeProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> registries) {
  ...
  public static class Ingredients {
    ...
    public static TagKey<Item> fence() {
      return TagKey.<Item>create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath("minecraft", "fences"));
    }

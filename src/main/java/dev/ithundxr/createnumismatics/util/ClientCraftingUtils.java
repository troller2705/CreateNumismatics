...
public class ClientCraftingUtils {
    ...
    public static @NotNull Result applyStackingCrafts(@NotNull ItemStack targetStack, @NotNull ItemStack droppedStack) {
        throw new NotImplementedException("ClientCraftingUtils.java - applyStackingCrafts()");
...
//
//        // it's either STORED_ENCHANTMENTS or ENCHANTMENTS
//        var enchantments = enchantedBook.get(DataComponents.STORED_ENCHANTMENTS);
//        if (enchantments == null || enchantments.isEmpty())
//            return Result.failureKeep();
//
//        targetStack = targetStack.copy();
//
//        EnchantmentHelper.getEnchantment
//

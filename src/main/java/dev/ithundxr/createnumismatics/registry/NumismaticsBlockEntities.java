...
/*    public static final BlockEntityEntry<SemaphoreBlockEntity> SEMAPHORE = REGISTRATE.blockEntity("semaphore", SemaphoreBlockEntity::new)
    ...
    public static final BlockEntityEntry<BankTerminalBlockEntity> BANK_TERMINAL = REGISTRATE.blockEntity("bank_terminal", BankTerminalBlockEntity::new)
        .validBlocks(NumismaticsBlocks.BANK_TERMINAL)
        .register();
